-- Generated from Simulink block FM_SysGen2/IQ_FIR_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity iq_fir_struct is
  port (
...
architecture structural of iq_fir_struct is 
...
begin
  ...
  src_clk_net <= clk_1;
  src_ce_net <= ce_1;
  constant_x0 : entity xil_defaultlib.sysgen_constant_9ee62c7e45 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_9ee62c7e45 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_5758b00bc609fad6449e5a825be15f74 
  port map (
  ...
  fir_compiler_7_2_1 : entity xil_defaultlib.xlfir_compiler_5758b00bc609fad6449e5a825be15f74 
  port map (
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity iq_fir_default_clock_driver is
  port (
...
end iq_fir_default_clock_driver;
architecture structural of iq_fir_default_clock_driver is 
begin
...
begin
  ...
  iq_fir_struct : entity xil_defaultlib.iq_fir_struct 
  port map (
    in1 => in1,
    in2 => in2,
    clk_1 => clk_1_net,
