...
#
# Generated by export_simulation on Wed Mar 25 23:41:28 -0700 2026
#
################################################################################
...
'-reset_run' switch to the './fm_demod_0.sh' script.

./fm_demod_0.sh -reset_run
...
./fm_demod_0.sh -noclean_files

For more information on the script, please type './fm_demod_0.sh -help'.
