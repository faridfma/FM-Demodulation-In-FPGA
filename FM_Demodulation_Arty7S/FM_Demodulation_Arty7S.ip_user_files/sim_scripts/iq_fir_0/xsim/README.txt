...
#
# Generated by export_simulation on Thu Mar 26 00:39:40 -0700 2026
#
################################################################################
...
'-reset_run' switch to the './iq_fir_0.sh' script.

./iq_fir_0.sh -reset_run
...
./iq_fir_0.sh -noclean_files

For more information on the script, please type './iq_fir_0.sh -help'.
